...
urlpatterns = [
    ...
    path('register_error/', views.TemplateView.as_view(template_name='users/register_error.html'),
         name='register_error'),
    path('password_reset/', password_reset, name='password_reset_form'),
    path('password_reset/done/', views.TemplateView.as_view(template_name='users/password_reset_done.html'),
